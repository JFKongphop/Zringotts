...
const customChain = {
  chain_id:     chainId,
  chain_name:   'Initia evm-1',
  network_type: 'testnet',
  bech32_prefix: 'init',
  apis: {
    rpc:       [{ address: process.env.NEXT_PUBLIC_INTERWOVEN_RPC_URL  ?? 'https://rpc-evm-1.anvil.asia-southeast.initia.xyz' }],
    rest:      [{ address: process.env.NEXT_PUBLIC_INTERWOVEN_REST_URL ?? 'https://rest-evm-1.anvil.asia-southeast.initia.xyz' }],
    indexer:   [{ address: process.env.NEXT_PUBLIC_INTERWOVEN_INDEXER_URL ?? 'https://indexer-evm-1.anvil.asia-southeast.initia.xyz' }],
  ...
  native_assets: [{ denom: bridgeDenom, name: 'Initia', symbol: 'INIT', decimals: 6 }],
